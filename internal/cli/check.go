...
func init() {
	...
	checkCmd.Flags().StringSlice("ct-domains", nil, "Domains to monitor in CT logs")
	checkCmd.Flags().StringSlice("ct-allowed-issuers", nil, "Expected CA issuers (others flagged as rogue)")
